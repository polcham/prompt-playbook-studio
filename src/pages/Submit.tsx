...
import { createPlaceholder, Placeholder } from "@/utils/promptUtils";
...
// Common placeholders for prompts - initial list
...
const Submit = () => {
  ...
  const addNewPlaceholder = () => {
    ...
    if (!exists) {
      ...
      handlePlaceholderSelect(newPlaceholder.label);
                          ...
                          <div className="relative">
                            ...
                            >
                              ...
                              <PopoverContent 
                                ...
                                onEscapeKeyDown={() => setPlaceholderCommandOpen(false)}
                                onInteractOutside={() => setPlaceholderCommandOpen(false)}
                              >
                                <Command>
                                  <CommandInput 
