...
import PromptFormFields, {
  FormValues,
} from "@/components/submit/PromptFormFields";
...
const formSchema = z.object({
  ...
  content: z
    .string()
    .min(20, { message: "Prompt content must be at least 20 characters" }),
  tool: z.string(),
  category: z.string(),
  authorName: z
    .string()
        ...
        <div className="container mx-auto max-w-3xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground">
              Share your AI prompt template with our community.
            </p>
          </div>
            ...
            {!isAuthenticated && (
              <div className="absolute inset-0 bg-background/80 backdrop-blur-sm z-10 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  You need to be signed-in to submit prompts and share with the
                  community.
                </p>
                <Button asChild>
