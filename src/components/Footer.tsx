        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Your go-to library for AI prompt templates. Find, copy, and share
